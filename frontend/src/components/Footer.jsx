    ...
    <footer className="footer-custom mt-auto">
      <div className="container">
        <div className="row gy-4 justify-content-between">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            <p className="footer-tagline mt-2">
              Connect, share, and grow with people who share your passions. Build your circle and shape your community today.
            </p>
          </div>
          ...
          <div className="col-lg-2 col-md-6">
            ...
            <ul className="footer-links-list">
              <li>
                <a href="#" onClick={handlePreventDefault} className="footer-link">Explore Circles</a>
              </li>
              <li>
        ...
        <div className="footer-copyright">
          <span>&copy; {new Date().getFullYear()} CircleUp. All rights reserved.</span>
